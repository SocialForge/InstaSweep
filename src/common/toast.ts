...
const info = (text: string, timeout = 5000): void => {
    void show(text, 'info', timeout);
};

const success = (text: string, timeout = 5000): void => {
    void show(text, 'success', timeout);
};

const error = (text: string, timeout = 5000): void => {
    void show(text, 'error', timeout);
};
